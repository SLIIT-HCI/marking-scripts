...
Students have to answer MCQs in online exams, and we can download only one file with all the student answer records (either in excel or csv format) from courseweb, which is difficult to access and mark it. This code will generate individual file with MCQ answers in an essay format for each student.<br.<br>
Instructions:
